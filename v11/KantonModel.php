...
class KantoneModel{
    ...
    public function getKanton( $attr=null, $val=null,$sortby=null ){
        ...
        foreach($this->kantone as $kanton)
        {
            if( $attr==null || $val==null ||
                [ $attr ] === $val ||
                @strtolower($kanton[ $attr ]) === @strtolower( $val )
            ){
                $result[$i]["name"] = $kanton["Kanton"];
                $result[$i]["hauptort"] = $kanton["Hauptort"];
                $result[$i]["einwohner"] = $kanton["Einwohner 1"];
                $result[$i]["beitritt"] = $kanton["Beitritt"];
            }
            $i++;
        }
